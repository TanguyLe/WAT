...
db.execute("CREATE TABLE position (id INTEGER PRIMARY KEY, position CHAR(100), createdDate DATETIME default current_timestamp, user INTEGER NOT NULL, FOREIGN KEY (user) REFERENCES user(id))")
