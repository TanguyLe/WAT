...
db.execute("CREATE TABLE message (id INTEGER PRIMARY KEY, message TEXT, createdDate DATETIME default current_timestamp, conversation INTEGER NOT NULL, user INTEGER NOT NULL, FOREIGN KEY(user, conversation) REFERENCES conversation_participant(user, conversation))")
db.execute("INSERT INTO message(message, conversation, user) VALUES ('Hello you', 1, 3)")
db.execute("INSERT INTO message(message, conversation, user) VALUES ('Hello you', 1, 2)")
db.commit()
